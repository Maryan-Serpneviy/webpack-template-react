...
function encode(buffer, options) {
    ...
    return native_1.__native_encode(buffer, width, height, alpha);
}
 ...
 */
function writePngFile(path, buffer, options, callback) {
    ...
    if (typeof callback === "function") {
        ...
        // if an error occured.
        fs_1.writeFile(path, encoded, callback);
        return;
    }
    ...
    return new Promise((resolve, reject) => {
        ...
        fs_1.writeFile(path, encoded, error => {
            if (error) {
                reject(error);
                return;
            }
 ...
 */
function writePngFileSync(path, buffer, options) {
    fs_1.writeFileSync(path, encode(buffer, options));
}
exports.writePngFileSync = writePngFileSync;
